...
This lab is due on **Tuesday, March 15 11:59pm.** To be considered on time, the following must be done by the due date:
...
Split the data into training (75%) and test (25%) sets. Use seed `210`.
...
b.  Describe the type of participants represented by the intercept.
...
Use the testing data to evaluate the model selected in the previous exercise.

a.  Make a confusion matrix of the actual versus predicted classes of `id`.
b.  Use the confusion matrix to comment on the model performance.

::: callout-tip
See [Multinomial Logistic Regression: Inference + Prediction](https://sta210-sp25.netlify.app/slides/22-multinomial-pt2#/title-slide) notes for help with code.
:::
