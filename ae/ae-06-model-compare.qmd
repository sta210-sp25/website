...
::: callout-important
Go to the [course GitHub organization](https://github.com/sta210-sp25) and locate your `ae-06` repo to get started.
...
Compute the predicted tips for the testing data.

Compute RMSE and R-sq for the testing data.
