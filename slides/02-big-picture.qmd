...
![](images/02/jama-retraction.png){fig-align="center" width="50%"}
...
::: aside
[Click here](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0253450) to access the original research paper.
:::

------------------------------------------------------------------------

## Life expectancy and education data
...
-   **Observations**: `r nrow(life_exp)` countries
-   **Variables:**
...
2.  Use the data to fit (or train) the model, i.e, **compute estimates the model parameters**, denoted $\hat{\beta}_0, \hat{\beta}_1, \ldots, \hat{\beta}_p$
...
## `life_exp` vs. `income_inequality` + `education`
...
## `life_exp` vs. `income_inequality` + `education` (with interaction)
