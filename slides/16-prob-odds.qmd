...
\[Insert win probability graph from a conference tournament game?\]
...
1.  Use age and age to predict if a randomly selected person will vote in the next election.
...
p1 <- ggplot(data = pew_data, aes(x = ai_concern)) + 
  ...
  labs(x = "", 
       title = "Concerned about AI in daily life?")
...
-   Based on this, we see that 65+ year olds are more likely to be concerned about the increased use of AI in daily life than 18-29 year olds.
:::
...
-   The odds a 65+ year old is concerned about increased use of AI in daily life are 1.934 (1/0.516) times the odds an 18-29 year old is concerned.
